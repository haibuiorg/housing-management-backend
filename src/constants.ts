...
export const PAYMENT_PRODUCT_ITEMS = 'payment_product_items';
export const SUBSCRIPTION_INVOICES = 'subscription_invoices';

export const CONTACT_LEADS = 'contact_leads';

export const CONTACT_LEADS_STATUS_NEW = 'new_lead';
export const CONTACT_LEADS_STATUS_PENDING = 'pending_lead';
export const CONTACT_LEADS_STATUS_ACCEPTED = 'accepted_lead';
...
export const PRIORLI_PUBLIC_LOGO_URL =
  'https://firebasestorage.googleapis.com/v0/b/priorli.appspot.com/o/public%2Flogo%2F3.png?alt=media&token=d0a036b2-5eff-4691-b752-21de74b9ce11';
